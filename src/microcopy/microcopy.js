const microcopy = {
  ...
  dashboard: {
    ...
    html: {
      ...
      recordingBlacklistTitle: 'Blocked apps',
      recordingBlacklistDescription: 'We recommend starting with your password manager.',
      recordingInstalledAppsDescription: 'Search for apps to block',
      recordingInstalledAppsRefresh: 'Refresh app list',
      recordingInstalledAppsRefreshing: 'Refreshing...',
      recordingInstalledAppsSearchPlaceholder: 'Secretive Mac App',
      ...
      recordingActionRequiredToProceed: 'Capturing stopped',
      ...
      storageUsageBreakdown: 'Disk usage',
